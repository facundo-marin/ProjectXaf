...
namespace ProjectXaf.Module.Controllers
{
    ...
    public partial class PrintSemiterminadosController : ViewController
    {
        // Use CodeRush to create Controllers and Actions with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/403133/
        public PrintSemiterminadosController()
        {
            InitializeComponent();
            // Target required Views (via the TargetXXX properties) and create their Actions.
            TargetObjectType = typeof(Semiterminados);
            SimpleAction printAction = new SimpleAction(this, "Imprimir semi", PredefinedCategory.Reports);
