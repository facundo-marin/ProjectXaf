...
public sealed class ProjectXafModule : ModuleBase
{
    public ProjectXafModule()
    {
        // 
        // ProjectXafModule
        // 
    ...
    public override void Setup(XafApplication application)
    {
        ...
        //PARA QUE NO SE GUARDE EL REGISTRO CUANDO SE CREA UN OBJETO NUEVO//
    ...
    {
        if (e.AuditOperationType == AuditOperationType.ObjectCreated)
        {
